...
# Env: REPO_DIR (default /opt/downstream-hub), BRANCH (default sit), PUBLIC_URL (default http://172.28.92.56:3010)
...
docker compose -f deploy/docker-compose.frontend.yml build --no-cache --build-arg "VITE_API_URL=${PUBLIC_URL}"
