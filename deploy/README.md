...
**Ports:** Public app **3010** (Nginx on app host), frontend container **3100**, Backend API **4000**, PostgreSQL **5432** (container, backend host publishes 5434 by default in compose).
